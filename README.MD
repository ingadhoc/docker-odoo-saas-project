...
export DOCKER_BUILDKIT=1 \
    ...
    -f Dockerfile .
# docker push adhoc/odoo-adhoc:18.0-dev
```

Run the image

```sh
docker run -it --rm --entrypoint="" adhoc/odoo-adhoc:18.0-dev  bash
# or
docker run -e WAIT_PG=False -it --rm adhoc/odoo-adhoc:18.0.dev bash
 ```
